...
//SapceBallz Packet Ident
const Ident_Packet :array[0..9] of byte =(83,112,97,99,101,66,97,108,108,122);
//largest packet
...
type TIdentArray =array[0..9] of byte;
...
type
  ...
  tPacketHdr =packed record
      PacketIdent:array[0..9] of byte;//unique identifier..
      Command    :byte;
      Option     :byte;
